      ...
      <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-gray-700">
            Découvrez notre application innovante et profitez de fonctionnalités
            exceptionnelles pour améliorer votre expérience.
          </p>
          <Link
            to="/dashboard"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold mb-4">
                  Accédez à des Services
                </h3>
                <p className="text-gray-600">
                  Description de la fonctionnalité 1. Cette fonctionnalité
                  permet aux utilisateurs de réaliser des actions spécifiques
                  avec facilité.
                </p>
              </div>
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Description de la fonctionnalité 2. Profitez de cette
                  fonctionnalité pour optimiser votre workflow et améliorer vos
                  résultats.
                </p>
              </div>
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Description de la fonctionnalité 3. Une fonctionnalité conçue
                  pour offrir une expérience utilisateur exceptionnelle et
                  fluide.
                </p>
              </div>
            </div>
